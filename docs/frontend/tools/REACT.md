...
**React Router >= 7.9 (Framework Mode)**

React Router 7 introduces framework mode, which provides a more integrated routing experience
similar to Next.js or Remix. This mode offers better data loading, error handling, and overall
developer experience while maintaining the flexibility of React Router.

- [React Router documentation](https://reactrouter.com/)
- [React Router framework mode guide](https://reactrouter.com/en/main/start/overview#framework-mode)
