...
1. **Encapsulation:** all types/utils/constants/subcomponents used only in a single component should be placed inside of it, if they're shared beetwen components then they should be treated as globals
